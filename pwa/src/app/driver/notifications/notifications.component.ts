...
/** Centre de notifications livreur : liste paginée + marquer lu + navigation vers une course liée. */
@Component({
...
export class DriverNotificationsComponent implements OnInit {
  ...
  open(notification: AppNotification): void {
    ...
    if (notification.deliveryId) {
      this.router.navigate(['/driver/my-deliveries', notification.deliveryId]);
    }
  }
}
