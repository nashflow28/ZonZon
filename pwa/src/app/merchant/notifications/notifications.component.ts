...
/** Centre de notifications commerçant : liste paginée + marquer lu + navigation vers une livraison liée. */
@Component({
...
export class MerchantNotificationsComponent implements OnInit {
  ...
  open(notification: AppNotification): void {
    ...
    if (notification.deliveryId) {
      this.router.navigate(['/merchant/deliveries', notification.deliveryId]);
    }
  }
}
