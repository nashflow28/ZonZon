...
- [ ] **Kit de marque — reste à arbitrer** — (a) icônes iOS du kit (12 fichiers, renommage nécessaire) : sans objet tant qu'iOS n'est pas distribué ; (b) splash screen Flutter : aucun logo affiché aujourd'hui, ce serait un ajout ; (c) usage du logo horizontal complet dans les en-têtes plutôt que le seul symbole.
