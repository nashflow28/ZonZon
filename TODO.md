...
- [~] **Audit flux mobile (P1/P2)** — corriger ensuite: deep-link de notification `direct_message`, filtrage des courses liables dans un fil direct, fallback `clientPhone` pour les livraisons commerçant sans compte client, premier fix GPS navigation livreur, pagination/compteur non lus notifications, rôle contrepartiste des réponses rapides dans Messages > Courses. *(audit 2026-07-12)*
