...
- [ ] **Kit de marque — reste à arbitrer** — (a) icônes iOS du kit (12 fichiers, renommage nécessaire) : sans objet tant qu'iOS n'est pas distribué ; (b) splash screen Flutter : aucun logo affiché aujourd'hui, ce serait un ajout ; ~~(c) logo horizontal dans les en-têtes~~ → fait le 2026-07-30, cf. PROGRESS.md session 97.
