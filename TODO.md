...
- [ ] **Choisir et finaliser la nouvelle identité ZonZon** — quatre pistes de logo explorées le 2026-07-29 : `Z-route`, `double-Z mouvement`, `colis ruban` et `wordmark premium`. Après arbitrage : redessiner la piste retenue en vectoriel, vérifier noir/blanc et petite taille, puis décliner icône Android/iOS/PWA, favicon, splash, sacs et réseaux sociaux. L'icône actuelle n'a pas été remplacée.
