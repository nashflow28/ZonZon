...
- [ ] **Révoquer et régénérer la clé Firebase Admin** *(sécurité, 2026-07-29)* — exposée en clair lors d'une lecture du `.env` de production. Console Firebase → Paramètres du projet → Comptes de service → générer une nouvelle clé, puis mettre à jour `FIREBASE_CREDENTIALS_JSON` sur le VPS.
