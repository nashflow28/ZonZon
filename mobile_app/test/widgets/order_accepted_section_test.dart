...
void main() {
  group('OrderAcceptedSection — bouton "Annuler la commande"', () {
    testWidgets(
      'PENDING + onCancelOrder non null → bouton visible et tap appelle le callback',
    ...
    testWidgets(
      'ACCEPTED → bouton "Annuler la commande" visible + bouton WhatsApp visible',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          _wrap(
            OrderAcceptedSection(
    ...
    testWidgets(
      'IN_PROGRESS → bouton "Annuler la commande" CACHÉ mais WhatsApp visible',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          _wrap(
            OrderAcceptedSection(
    ...
    testWidgets(
      'onCancelOrder = null → bouton CACHÉ même si status = PENDING',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          _wrap(
